...
$query = "SELECT * FROM Post, Category WHERE Post.category_id = Category.category_id AND Category.category_name = 'Sports'";
$result = $conn->query($query);
...
if ($result->num_rows > 0) {
    ...
    // Pagination links
    $query = "SELECT COUNT(*) as total FROM Post Where category_id = 2";
    $result = $conn->query($query);
